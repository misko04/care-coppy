<template>
  <header
    class="relative inset-x-0 top-0 z-[110] bg-transparent transition-transform duration-300 translate-y-0"
  >
    <div
      ...
      >
        ...
        <nav class="hidden xl:block">
          ...
          >
            ...
            >
              <p class="text-black" v-if="language">So funktioniert's</p>
              <p class="text-black" v-if="!language">How it works</p>
            </NuxtLink>
            <NuxtLink
              to="/preise"
              class="block max-w-max w-full text-center font-500 duration-300 relative border border-transparent bg-transparent"
            >
              <p class="text-black" v-if="language">Preise</p>
              <p class="text-black" v-if="!language">Pricing</p>
            </NuxtLink>
            <NuxtLink
              to="/versicherung"
              class="block max-w-max w-full text-center font-500 duration-300 relative border border-transparent bg-transparent"
              ><p class="text-black" v-if="language">Versicherung</p>
              <p class="text-black" v-if="!language">Insurance</p>
            </NuxtLink>
            <NuxtLink
              to="/standorte"
              class="block max-w-max w-full text-center font-500 duration-300 relative border border-transparent bg-transparent"
              ><p class="text-black" v-if="language">Standorte</p>
              <p class="text-black" v-if="!language">Locations</p>
            </NuxtLink>
            <div class="relative z-[10] text-left">
              ...
              >
                <span>
                  <p class="text-black" v-if="language">Mehr</p>
                  <p class="text-black" v-if="!language">More</p>
                </span>
                <div
  ...
  <div
    v-show="shMenu"
    class="fixed inset-0 z-[120] flex flex-col overflow-y-auto bg-white xl:hidden"
  >
    <div
      class="w-full px-[24px] mx-auto md:px-[48px] md:max-w-[calc(672px+48px+48px)] xl:max-w-[calc(1188px+48px+48px)] h-full"
    >
